...
namespace GarageV2.Controllers
{
    public class ParkedVehicles2Controller : Controller
    {
        ...
        public ParkedVehicles2Controller(GarageV2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,RegNo,Color,Brand,Model,NoWheels,CheckIn")] ParkedVehicle parkedVehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RegNo,Color,Brand,Model,NoWheels,CheckIn")] ParkedVehicle parkedVehicle)
        {
